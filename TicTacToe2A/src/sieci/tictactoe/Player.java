...
public class Player extends Thread {
	...
	/**
	 * Number of points the player has gotten so far.
	 */
	private int score;
	/**
	...
	public Player(TTTGame game, Socket socket) throws IOException {
		...
		// System.out.println("Wysylam wielkosc: " + this.game.getSize());
		output.writeObject(this.game.getSize());
		output.writeObject(symbol);

		this.game.requestMap(this);
		this.game.requestCurrentPlayer(this);
	}
	...
	/**
	 * Gives the value of score object.
	 * 
	 * @return The score.
	 */
	public int getScore() {
